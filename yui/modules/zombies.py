...
from Yui import telethn as YuiTelethonClient
from Yui.modules.sql.clear_cmd_sql import get_clearcmd
from Yui.modules.helper_funcs.telethn.chatstatus import user_is_admin
from Yui.modules.helper_funcs.misc import delete


@YuiTelethonClient.on(events.NewMessage(pattern=f"^[!/]zombies ?(.*)"))
