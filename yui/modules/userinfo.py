...
from Yui.__main__ import STATS, GDPR, TOKEN, USER_INFO
...
from Yui.modules.sql.afk_sql import is_afk, check_afk_status
...
from Yui import telethn as YuiTelethonClient, SUDO_USERS, SUPPORT_USERS
...
def gdpr(update: Update, context: CallbackContext):
    ...
    update.effective_message.reply_text("Your personal data has been deleted.\n\nNote that this will not unban "
                                        "you from any chats, as that is telegram data, not Yui data. "
